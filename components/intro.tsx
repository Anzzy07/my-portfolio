...
<span className="font-bold">frontend developer but mostly going full-stack</span> with{" "}
<span className="font-bold">2 years</span> of experience. I enjoy building{" "}
<span className="italic">sites & apps</span>. My focus is to{" "}
<span className="underline">contribute something to society</span>.{" "}
<span>The learning never stops </span>
<span className="font-bold">(Full-stack, obviously).</span>{" "}
<span className="italic"> Feel free to explore.</span>
      </motion.h1>
